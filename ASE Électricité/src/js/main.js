...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const div1Items = document.querySelectorAll(
    ".div1 .items-body-content[data-img-div2]"
  );
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const div3Items = document.querySelectorAll(
    ".div3 .items-body-content[data-img-div4]"
  );
  const div4Photo = document.getElementById("div4-photo");
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const div5Items = document.querySelectorAll(
    ".div5 .items-body-content[data-img-div6]"
  );
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const div7Items = document.querySelectorAll(
    ".div7 .items-body-content[data-img-div8]"
  );
